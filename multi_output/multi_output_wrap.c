...
int _wrap_divide_fun(SWIG_GatewayParameters) {
  int *arg1 = (int *) 0 ;
  int *arg2 = (int *) 0 ;
  int *arg3 = (int *) 0 ;
  int *arg4 = (int *) 0 ;
  ...
  if (!(SWIG_IsOK((res1 = SwigScilabPtrToObject(pvApiCtx, 1, SWIG_as_voidptrptr(&arg1), SWIGTYPE_p_int, 0, SWIG_Scilab_GetFuncName()))))) {
    int val; 
    int ecode = SWIG_AsVal_int(1, &val);
    if (!SWIG_IsOK(ecode)) {
      SWIG_exception_fail(SWIG_ArgError(ecode), "in method '" "divide_fun" "', argument " "1"" of type '" "int""'");
    }
    temp1 = (int)(val);
    arg1 = &temp1;
    res1 = SWIG_AddTmpMask(ecode);
  }
  if (!(SWIG_IsOK((res2 = SwigScilabPtrToObject(pvApiCtx, 2, SWIG_as_voidptrptr(&arg2), SWIGTYPE_p_int, 0, SWIG_Scilab_GetFuncName()))))) {
    int val; 
    int ecode = SWIG_AsVal_int(2, &val);
    if (!SWIG_IsOK(ecode)) {
      SWIG_exception_fail(SWIG_ArgError(ecode), "in method '" "divide_fun" "', argument " "2"" of type '" "int""'");
    }
    temp2 = (int)(val);
    arg2 = &temp2;
    res2 = SWIG_AddTmpMask(ecode);
  }
  result = (int)divide_fun(arg1,arg2,arg3,arg4);
  SWIG_Scilab_SetOutputPosition(1);
  if (!SWIG_IsOK(SWIG_Scilab_SetOutput(pvApiCtx, SWIG_From_int((int)(result))))) return SWIG_ERROR;
  SWIG_Scilab_SetOutputPosition(2);
  if (!SWIG_IsOK(SWIG_Scilab_SetOutput(pvApiCtx, SWIG_From_int  (*arg3)))) return SWIG_ERROR;
  SWIG_Scilab_SetOutputPosition(3);
  if (!SWIG_IsOK(SWIG_Scilab_SetOutput(pvApiCtx, SWIG_From_int  (*arg4)))) return SWIG_ERROR;
  return SWIG_OK;
}
...
extern "C"
#endif
int multi_output_Init(SWIG_GatewayParameters) {
...
#define MODULE_NAME L"libmulti_output"
#ifdef __cplusplus
extern "C"
#endif
int libmulti_output(wchar_t *pwstFuncName) {
  if (wcscmp(pwstFuncName, L"multi_output_Init") == 0) {
    addCStackFunction((wchar_t *)L"multi_output_Init", &multi_output_Init, (wchar_t *)MODULE_NAME); 
  }
  ...
  if (wcscmp(pwstFuncName, L"divide_fun") == 0) {
    addCStackFunction((wchar_t *)L"divide_fun", &_wrap_divide_fun, (wchar_t *)MODULE_NAME); 
  }
  return 1;
};
#else
static GenericTable Tab[] = {
  {
    (Myinterfun)sci_gateway, (GT)multi_output_Init, (char *)"multi_output_Init"
  },
  {
  ...
  {
    (Myinterfun)sci_gateway, (GT)_wrap_divide_fun, (char *)"divide_fun"
  }
};
