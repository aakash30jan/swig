...
int _wrap_Point_x_set(SWIG_GatewayParameters) {
  ...
  res1 = SwigScilabPtrToObject(pvApiCtx, 1, &argp1, SWIGTYPE_p_Point, 0 |  0 , SWIG_Scilab_GetFuncName());
  if (!SWIG_IsOK(res1)) {
...
int _wrap_new_Point(SWIG_GatewayParameters) {
  ...
  SWIG_Scilab_SetOutputPosition(1);
  if (!SWIG_IsOK(SWIG_Scilab_SetOutput(pvApiCtx, SwigScilabPtrFromObject(pvApiCtx, SWIG_Scilab_GetOutputPosition(), SWIG_as_voidptr(result), SWIGTYPE_p_Point, 1 |  0 , NULL)))) return SWIG_ERROR;
  return SWIG_OK;
}


int _wrap_Point_distance(SWIG_GatewayParameters) {
  Point *arg1 = (Point *) 0 ;
  Point *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  arg1 = (Point *)(argp1);
  res2 = SwigScilabPtrToObject(pvApiCtx, 2, &argp2, SWIGTYPE_p_Point,  0 , SWIG_Scilab_GetFuncName());
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "Point_distance" "', argument " "2"" of type '" "Point const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "Point_distance" "', argument " "2"" of type '" "Point const &""'"); 
  }
  arg2 = (Point *)(argp2);
...
int _wrap_Point_set(SWIG_GatewayParameters) {
  Point *arg1 = (Point *) 0 ;
  int arg2 ;
  int arg3 ;
  void *argp1 = 0 ;
  ...
  res1 = SwigScilabPtrToObject(pvApiCtx, 1, &argp1, SWIGTYPE_p_Point, 0 |  0 , SWIG_Scilab_GetFuncName());
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Point_set" "', argument " "1"" of type '" "Point *""'"); 
  }
  arg1 = (Point *)(argp1);
  ecode2 = SWIG_AsVal_int(2, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "Point_set" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
  ecode3 = SWIG_AsVal_int(3, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "Point_set" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = (int)(val3);
  (arg1)->set(arg2,arg3);
...
int _wrap_delete_Point(SWIG_GatewayParameters) {
  ...
  SWIG_Scilab_SetFuncName(fname);
  SWIG_Scilab_SetApiContext(pvApiCtx);
  res1 = SwigScilabPtrToObject(pvApiCtx, 1, &argp1, SWIGTYPE_p_Point, SWIG_POINTER_DISOWN |  0 , SWIG_Scilab_GetFuncName());
  if (!SWIG_IsOK(res1)) {
...
extern "C"
#endif
int classes_Init(SWIG_GatewayParameters) {
...
#define MODULE_NAME L"libclasses"
#ifdef __cplusplus
extern "C"
#endif
int libclasses(wchar_t *pwstFuncName) {
  if (wcscmp(pwstFuncName, L"classes_Init") == 0) {
    addCStackFunction((wchar_t *)L"classes_Init", &classes_Init, (wchar_t *)MODULE_NAME); 
  }
  ...
  if (wcscmp(pwstFuncName, L"Point_x_set") == 0) {
    addCStackFunction((wchar_t *)L"Point_x_set", &_wrap_Point_x_set, (wchar_t *)MODULE_NAME); 
  }
  if (wcscmp(pwstFuncName, L"Point_x_get") == 0) {
    addCStackFunction((wchar_t *)L"Point_x_get", &_wrap_Point_x_get, (wchar_t *)MODULE_NAME); 
  }
  if (wcscmp(pwstFuncName, L"Point_y_set") == 0) {
    addCStackFunction((wchar_t *)L"Point_y_set", &_wrap_Point_y_set, (wchar_t *)MODULE_NAME); 
  }
  if (wcscmp(pwstFuncName, L"Point_y_get") == 0) {
    addCStackFunction((wchar_t *)L"Point_y_get", &_wrap_Point_y_get, (wchar_t *)MODULE_NAME); 
  }
  if (wcscmp(pwstFuncName, L"new_Point") == 0) {
    addCStackFunction((wchar_t *)L"new_Point", &_wrap_new_Point, (wchar_t *)MODULE_NAME); 
  }
  if (wcscmp(pwstFuncName, L"Point_distance") == 0) {
    addCStackFunction((wchar_t *)L"Point_distance", &_wrap_Point_distance, (wchar_t *)MODULE_NAME); 
  }
  if (wcscmp(pwstFuncName, L"Point_set") == 0) {
    addCStackFunction((wchar_t *)L"Point_set", &_wrap_Point_set, (wchar_t *)MODULE_NAME); 
  }
  if (wcscmp(pwstFuncName, L"delete_Point") == 0) {
    addCStackFunction((wchar_t *)L"delete_Point", &_wrap_delete_Point, (wchar_t *)MODULE_NAME); 
  }
  return 1;
};
#else
static GenericTable Tab[] = {
  {
    (Myinterfun)sci_gateway, (GT)classes_Init, (char *)"classes_Init"
  },
  {
  ...
  {
    (Myinterfun)sci_gateway, (GT)_wrap_Point_x_set, (char *)"Point_x_set"
  },
  {
    (Myinterfun)sci_gateway, (GT)_wrap_Point_x_get, (char *)"Point_x_get"
  },
  {
    (Myinterfun)sci_gateway, (GT)_wrap_Point_y_set, (char *)"Point_y_set"
  },
  {
    (Myinterfun)sci_gateway, (GT)_wrap_Point_y_get, (char *)"Point_y_get"
  },
  {
    (Myinterfun)sci_gateway, (GT)_wrap_new_Point, (char *)"new_Point"
  },
  {
    (Myinterfun)sci_gateway, (GT)_wrap_Point_distance, (char *)"Point_distance"
  },
  {
    (Myinterfun)sci_gateway, (GT)_wrap_Point_set, (char *)"Point_set"
  },
  {
    (Myinterfun)sci_gateway, (GT)_wrap_delete_Point, (char *)"delete_Point"
  }
};
