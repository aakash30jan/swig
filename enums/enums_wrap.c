...
int RED_get(SWIG_GatewayParameters) {
  ...
  SWIG_Scilab_SetOutputPosition(1);
  if (!SWIG_IsOK(SWIG_Scilab_SetOutput(pvApiCtx, SWIG_From_int((int)(RED))))) return SWIG_ERROR;
  return SWIG_OK;
}


int BLUE_get(SWIG_GatewayParameters) {
  SWIG_CheckInputArgument(pvApiCtx, 0, 0);
  SWIG_CheckOutputArgument(pvApiCtx, 1, 1);
  SWIG_Scilab_SetApiContext(pvApiCtx);
  ...
  SWIG_Scilab_SetOutputPosition(1);
  if (!SWIG_IsOK(SWIG_Scilab_SetOutput(pvApiCtx, SWIG_From_int((int)(BLUE))))) return SWIG_ERROR;
  return SWIG_OK;
}


int GREEN_get(SWIG_GatewayParameters) {
  SWIG_CheckInputArgument(pvApiCtx, 0, 0);
  SWIG_CheckOutputArgument(pvApiCtx, 1, 1);
  SWIG_Scilab_SetApiContext(pvApiCtx);
  ...
  SWIG_Scilab_SetOutputPosition(1);
  if (!SWIG_IsOK(SWIG_Scilab_SetOutput(pvApiCtx, SWIG_From_int((int)(GREEN))))) return SWIG_ERROR;
  return SWIG_OK;
}
...
static swig_type_info _swigt__p_color = {"_p_color", "enum color *|color *", 0, 0, (void*)0, 0};
...
extern "C"
#endif
int enums_Init(SWIG_GatewayParameters) {
...
#define MODULE_NAME L"libenums"
#ifdef __cplusplus
extern "C"
#endif
int libenums(wchar_t *pwstFuncName) {
  if (wcscmp(pwstFuncName, L"enums_Init") == 0) {
    addCStackFunction((wchar_t *)L"enums_Init", &enums_Init, (wchar_t *)MODULE_NAME); 
  }
  ...
  if (wcscmp(pwstFuncName, L"RED_get") == 0) {
    addCStackFunction((wchar_t *)L"RED_get", &RED_get, (wchar_t *)MODULE_NAME); 
  }
  if (wcscmp(pwstFuncName, L"BLUE_get") == 0) {
    addCStackFunction((wchar_t *)L"BLUE_get", &BLUE_get, (wchar_t *)MODULE_NAME); 
  }
  if (wcscmp(pwstFuncName, L"GREEN_get") == 0) {
    addCStackFunction((wchar_t *)L"GREEN_get", &GREEN_get, (wchar_t *)MODULE_NAME); 
  }
  return 1;
};
#else
static GenericTable Tab[] = {
  {
    (Myinterfun)sci_gateway, (GT)enums_Init, (char *)"enums_Init"
  },
  {
  ...
  {
    (Myinterfun)sci_gateway, (GT)RED_get, (char *)"RED_get"
  },
  {
    (Myinterfun)sci_gateway, (GT)BLUE_get, (char *)"BLUE_get"
  },
  {
    (Myinterfun)sci_gateway, (GT)GREEN_get, (char *)"GREEN_get"
  }
};
