...
int SWIG_CreateScilabVariables(void *_pvApiCtx) {
  if (SWIG_CreateScilabVariable_int(pvApiCtx, "ICONST", 42) != SWIG_OK)
    return SWIG_ERROR;


  if (SWIG_CreateScilabVariable_double(pvApiCtx, "FCONST", 2.1828) != SWIG_OK)
    return SWIG_ERROR;


  if (SWIG_CreateScilabVariable_char(pvApiCtx, "CCONST", 'x') != SWIG_OK)
    return SWIG_ERROR;


  if (SWIG_CreateScilabVariable_char(pvApiCtx, "CCONST2", '\n') != SWIG_OK)
    return SWIG_ERROR;


  if (SWIG_CreateScilabVariable_charptr(pvApiCtx, "SCONST", "Hello World") != SWIG_OK)
    return SWIG_ERROR;


  if (SWIG_CreateScilabVariable_charptr(pvApiCtx, "SCONST2", "\"Hello World\"") != SWIG_OK)
    return SWIG_ERROR;
...
extern "C"
#endif
int constants_Init(SWIG_GatewayParameters) {
...
#define MODULE_NAME L"libconstants"
#ifdef __cplusplus
extern "C"
#endif
int libconstants(wchar_t *pwstFuncName) {
  if (wcscmp(pwstFuncName, L"constants_Init") == 0) {
    addCStackFunction((wchar_t *)L"constants_Init", &constants_Init, (wchar_t *)MODULE_NAME); 
  }
...
static GenericTable Tab[] = {
  {
    (Myinterfun)sci_gateway, (GT)constants_Init, (char *)"constants_Init"
  },
  {
