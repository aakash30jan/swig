...
int std_get(SWIG_GatewayParameters) {
  ...
  SWIG_Scilab_SetOutputPosition(1);
  if (!SWIG_IsOK(SWIG_Scilab_SetOutput(pvApiCtx, SwigScilabPtrFromObject(pvApiCtx, SWIG_Scilab_GetOutputPosition(), SWIG_as_voidptr(&std), SWIGTYPE_p_namespace,  0 , NULL)))) return SWIG_ERROR;
  return SWIG_OK;
}


int std_set(SWIG_GatewayParameters) {
  ...
  {
    void *argp = 0;
    int res = SwigScilabPtrToObject(pvApiCtx, 1, &argp, SWIGTYPE_p_namespace,  0 , SWIG_Scilab_GetFuncName());
    if (!SWIG_IsOK(res)) {
...
extern "C"
#endif
int pairing_Init(SWIG_GatewayParameters) {
...
#define MODULE_NAME L"libpairing"
#ifdef __cplusplus
extern "C"
#endif
int libpairing(wchar_t *pwstFuncName) {
  if (wcscmp(pwstFuncName, L"pairing_Init") == 0) {
    addCStackFunction((wchar_t *)L"pairing_Init", &pairing_Init, (wchar_t *)MODULE_NAME); 
  }
  ...
  if (wcscmp(pwstFuncName, L"std_get") == 0) {
    addCStackFunction((wchar_t *)L"std_get", &std_get, (wchar_t *)MODULE_NAME); 
  }
  if (wcscmp(pwstFuncName, L"std_set") == 0) {
    addCStackFunction((wchar_t *)L"std_set", &std_set, (wchar_t *)MODULE_NAME); 
  }
  return 1;
};
#else
static GenericTable Tab[] = {
  {
    (Myinterfun)sci_gateway, (GT)pairing_Init, (char *)"pairing_Init"
  },
  {
  ...
  {
    (Myinterfun)sci_gateway, (GT)std_get, (char *)"std_get"
  },
  {
    (Myinterfun)sci_gateway, (GT)std_set, (char *)"std_set"
  }
};
