...
int _wrap_sub(SWIG_GatewayParameters) {
  int *arg1 = (int *) 0 ;
  int *arg2 = (int *) 0 ;
  int *arg3 = (int *) 0 ;
  int temp1 ;
...
int _wrap_inc(SWIG_GatewayParameters) {
  ...
  if (!(SWIG_IsOK((res2 = SwigScilabPtrToObject(pvApiCtx, 2, SWIG_as_voidptrptr(&arg2), SWIGTYPE_p_int, 0, SWIG_Scilab_GetFuncName()))))) {
    ...
    int ecode = SWIG_AsVal_int(2, &val);
    if (!SWIG_IsOK(ecode)) {
      SWIG_exception_fail(SWIG_ArgError(ecode), "in method '" "inc" "', argument " "2"" of type '" "int""'");
    }
    temp2 = (int)(val);
    arg2 = &temp2;
    res2 = SWIG_AddTmpMask(ecode);
  ...
  SWIG_Scilab_SetOutputPosition(1);
  if (!SWIG_IsOK(SWIG_Scilab_SetOutput(pvApiCtx, SWIG_From_int  (*arg1)))) return SWIG_ERROR;
  return SWIG_OK;
}
...
extern "C"
#endif
int args_Init(SWIG_GatewayParameters) {
...
#define MODULE_NAME L"libargs"
#ifdef __cplusplus
extern "C"
#endif
int libargs(wchar_t *pwstFuncName) {
  if (wcscmp(pwstFuncName, L"args_Init") == 0) {
    addCStackFunction((wchar_t *)L"args_Init", &args_Init, (wchar_t *)MODULE_NAME); 
  }
  ...
  if (wcscmp(pwstFuncName, L"sub") == 0) {
    addCStackFunction((wchar_t *)L"sub", &_wrap_sub, (wchar_t *)MODULE_NAME); 
  }
...
static GenericTable Tab[] = {
  {
    (Myinterfun)sci_gateway, (GT)args_Init, (char *)"args_Init"
  },
  {
  ...
  {
    (Myinterfun)sci_gateway, (GT)_wrap_sub, (char *)"sub"
  },
  {
