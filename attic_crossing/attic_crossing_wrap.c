...
int _wrap_attic(SWIG_GatewayParameters) {
  char *arg1 = (char *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
  int alloc1 = 0 ;
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "attic" "', argument " "1"" of type '" "char *""'");
  }
  arg1 = (char *)(buf1);
  result = (int)attic(arg1);
  SWIG_Scilab_SetOutputPosition(1);
...
extern "C"
#endif
int attic_crossing_Init(SWIG_GatewayParameters) {
...
#define MODULE_NAME L"libattic_crossing"
#ifdef __cplusplus
extern "C"
#endif
int libattic_crossing(wchar_t *pwstFuncName) {
  if (wcscmp(pwstFuncName, L"attic_crossing_Init") == 0) {
    addCStackFunction((wchar_t *)L"attic_crossing_Init", &attic_crossing_Init, (wchar_t *)MODULE_NAME); 
  }
  ...
  if (wcscmp(pwstFuncName, L"attic") == 0) {
    addCStackFunction((wchar_t *)L"attic", &_wrap_attic, (wchar_t *)MODULE_NAME); 
  }
  return 1;
};
#else
static GenericTable Tab[] = {
  {
    (Myinterfun)sci_gateway, (GT)attic_crossing_Init, (char *)"attic_crossing_Init"
  },
  {
  ...
  {
    (Myinterfun)sci_gateway, (GT)_wrap_attic, (char *)"attic"
  }
};
