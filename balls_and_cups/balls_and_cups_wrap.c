...
int _wrap_balls_and_cups(SWIG_GatewayParameters) {
  int arg1 ;
  int arg2 ;
  int arg3 ;
  int arg4 ;
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "balls_and_cups" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  ecode2 = SWIG_AsVal_int(2, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "balls_and_cups" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
  ecode3 = SWIG_AsVal_int(3, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "balls_and_cups" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = (int)(val3);
  ecode4 = SWIG_AsVal_int(4, &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "balls_and_cups" "', argument " "4"" of type '" "int""'");
  } 
  arg4 = (int)(val4);
  ecode5 = SWIG_AsVal_int(5, &val5);
  if (!SWIG_IsOK(ecode5)) {
    SWIG_exception_fail(SWIG_ArgError(ecode5), "in method '" "balls_and_cups" "', argument " "5"" of type '" "int""'");
  } 
  arg5 = (int)(val5);
  result = (int)balls_and_cups(arg1,arg2,arg3,arg4,arg5);
  SWIG_Scilab_SetOutputPosition(1);
...
extern "C"
#endif
int balls_and_cups_Init(SWIG_GatewayParameters) {
...
#define MODULE_NAME L"libballs_and_cups"
#ifdef __cplusplus
extern "C"
#endif
int libballs_and_cups(wchar_t *pwstFuncName) {
  if (wcscmp(pwstFuncName, L"balls_and_cups_Init") == 0) {
    addCStackFunction((wchar_t *)L"balls_and_cups_Init", &balls_and_cups_Init, (wchar_t *)MODULE_NAME); 
  }
  ...
  if (wcscmp(pwstFuncName, L"balls_and_cups") == 0) {
    addCStackFunction((wchar_t *)L"balls_and_cups", &_wrap_balls_and_cups, (wchar_t *)MODULE_NAME); 
  }
  return 1;
};
#else
static GenericTable Tab[] = {
  {
    (Myinterfun)sci_gateway, (GT)balls_and_cups_Init, (char *)"balls_and_cups_Init"
  },
  {
  ...
  {
    (Myinterfun)sci_gateway, (GT)_wrap_balls_and_cups, (char *)"balls_and_cups"
  }
};
