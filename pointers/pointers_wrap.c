...
SWIG_SciString_AsCharPtrAndSize(void *pvApiCtx, int iVar, char **pcValue, size_t *piLength, int *alloc, char *fname) {
  ...
  pstString = (char *)calloc(iLen + 1, sizeof(char));
...
int _wrap_fopen(SWIG_GatewayParameters) {
  char *arg1 = (char *) 0 ;
  char *arg2 = (char *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
  ...
  SWIG_Scilab_SetOutputPosition(1);
  if (!SWIG_IsOK(SWIG_Scilab_SetOutput(pvApiCtx, SwigScilabPtrFromObject(pvApiCtx, SWIG_Scilab_GetOutputPosition(), SWIG_as_voidptr(result), SWIGTYPE_p_FILE, 0 |  0 , NULL)))) return SWIG_ERROR;
...
int _wrap_fputs(SWIG_GatewayParameters) {
  char *arg1 = (char *) 0 ;
  FILE *arg2 = (FILE *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
  ...
  arg1 = (char *)(buf1);
  res2 = SwigScilabPtrToObject(pvApiCtx, 2, &argp2, SWIGTYPE_p_FILE, 0 |  0 , SWIG_Scilab_GetFuncName());
  if (!SWIG_IsOK(res2)) {
...
int _wrap_fclose(SWIG_GatewayParameters) {
  FILE *arg1 = (FILE *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  int result;
  ...
  SWIG_Scilab_SetFuncName(fname);
  SWIG_Scilab_SetApiContext(pvApiCtx);
  res1 = SwigScilabPtrToObject(pvApiCtx, 1, &argp1, SWIGTYPE_p_FILE, 0 |  0 , SWIG_Scilab_GetFuncName());
  if (!SWIG_IsOK(res1)) {
...
extern "C"
#endif
int pointers_Init(SWIG_GatewayParameters) {
...
#define MODULE_NAME L"libpointers"
#ifdef __cplusplus
extern "C"
#endif
int libpointers(wchar_t *pwstFuncName) {
  if (wcscmp(pwstFuncName, L"pointers_Init") == 0) {
    addCStackFunction((wchar_t *)L"pointers_Init", &pointers_Init, (wchar_t *)MODULE_NAME); 
  }
  ...
  if (wcscmp(pwstFuncName, L"fopen") == 0) {
    addCStackFunction((wchar_t *)L"fopen", &_wrap_fopen, (wchar_t *)MODULE_NAME); 
  }
  if (wcscmp(pwstFuncName, L"fputs") == 0) {
    addCStackFunction((wchar_t *)L"fputs", &_wrap_fputs, (wchar_t *)MODULE_NAME); 
  }
  if (wcscmp(pwstFuncName, L"fclose") == 0) {
    addCStackFunction((wchar_t *)L"fclose", &_wrap_fclose, (wchar_t *)MODULE_NAME); 
  }
  return 1;
};
#else
static GenericTable Tab[] = {
  {
    (Myinterfun)sci_gateway, (GT)pointers_Init, (char *)"pointers_Init"
  },
  {
  ...
  {
    (Myinterfun)sci_gateway, (GT)_wrap_fopen, (char *)"fopen"
  },
  {
    (Myinterfun)sci_gateway, (GT)_wrap_fputs, (char *)"fputs"
  },
  {
    (Myinterfun)sci_gateway, (GT)_wrap_fclose, (char *)"fclose"
  }
};
