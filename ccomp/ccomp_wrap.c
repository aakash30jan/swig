...
int _wrap_ccomp(SWIG_GatewayParameters) {
  int arg1 ;
  int arg2 ;
  int *arg3 ;
  int *arg4 ;
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "ccomp" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  ecode2 = SWIG_AsVal_int(2, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ccomp" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = (int)(val2);
  {
    size_t i = 0;
  ...
  result = (int)ccomp(arg1,arg2,arg3,arg4);
  SWIG_Scilab_SetOutputPosition(1);
...
extern "C"
#endif
int ccomp_Init(SWIG_GatewayParameters) {
...
#define MODULE_NAME L"libccomp"
#ifdef __cplusplus
extern "C"
#endif
int libccomp(wchar_t *pwstFuncName) {
  if (wcscmp(pwstFuncName, L"ccomp_Init") == 0) {
    addCStackFunction((wchar_t *)L"ccomp_Init", &ccomp_Init, (wchar_t *)MODULE_NAME); 
  }
  ...
  if (wcscmp(pwstFuncName, L"ccomp") == 0) {
    addCStackFunction((wchar_t *)L"ccomp", &_wrap_ccomp, (wchar_t *)MODULE_NAME); 
  }
  return 1;
};
#else
static GenericTable Tab[] = {
  {
    (Myinterfun)sci_gateway, (GT)ccomp_Init, (char *)"ccomp_Init"
  },
  {
  ...
  {
    (Myinterfun)sci_gateway, (GT)_wrap_ccomp, (char *)"ccomp"
  }
};
