...
int _wrap_fact(SWIG_GatewayParameters) {
  int arg1 ;
  int val1 ;
  int ecode1 = 0 ;
  int result;
...
extern "C"
#endif
int fact_Init(SWIG_GatewayParameters) {
...
#define MODULE_NAME L"libfact"
#ifdef __cplusplus
extern "C"
#endif
int libfact(wchar_t *pwstFuncName) {
  if (wcscmp(pwstFuncName, L"fact_Init") == 0) {
    addCStackFunction((wchar_t *)L"fact_Init", &fact_Init, (wchar_t *)MODULE_NAME); 
  }
  ...
  if (wcscmp(pwstFuncName, L"fact") == 0) {
    addCStackFunction((wchar_t *)L"fact", &_wrap_fact, (wchar_t *)MODULE_NAME); 
  }
  return 1;
};
#else
static GenericTable Tab[] = {
  {
    (Myinterfun)sci_gateway, (GT)fact_Init, (char *)"fact_Init"
  },
  {
  ...
  {
    (Myinterfun)sci_gateway, (GT)_wrap_fact, (char *)"fact"
  }
};
