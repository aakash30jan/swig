...
int _wrap_sortit(SWIG_GatewayParameters) {
  int arg1 ;
  int *arg2 ;
  int val1 ;
  int ecode1 = 0 ;
  ...
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "sortit" "', argument " "1"" of type '" "int""'");
  } 
  arg1 = (int)(val1);
  {
    size_t i = 0;
...
extern "C"
#endif
int sortit_Init(SWIG_GatewayParameters) {
...
#define MODULE_NAME L"libsortit"
#ifdef __cplusplus
extern "C"
#endif
int libsortit(wchar_t *pwstFuncName) {
  if (wcscmp(pwstFuncName, L"sortit_Init") == 0) {
    addCStackFunction((wchar_t *)L"sortit_Init", &sortit_Init, (wchar_t *)MODULE_NAME); 
  }
  ...
  if (wcscmp(pwstFuncName, L"sortit") == 0) {
    addCStackFunction((wchar_t *)L"sortit", &_wrap_sortit, (wchar_t *)MODULE_NAME); 
  }
  return 1;
};
#else
static GenericTable Tab[] = {
  {
    (Myinterfun)sci_gateway, (GT)sortit_Init, (char *)"sortit_Init"
  },
  {
  ...
  {
    (Myinterfun)sci_gateway, (GT)_wrap_sortit, (char *)"sortit"
  }
};
