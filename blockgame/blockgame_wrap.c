...
int _wrap_blockgame(SWIG_GatewayParameters) {
  int result;
...
extern "C"
#endif
int blockgame_Init(SWIG_GatewayParameters) {
...
#define MODULE_NAME L"libblockgame"
#ifdef __cplusplus
extern "C"
#endif
int libblockgame(wchar_t *pwstFuncName) {
  if (wcscmp(pwstFuncName, L"blockgame_Init") == 0) {
    addCStackFunction((wchar_t *)L"blockgame_Init", &blockgame_Init, (wchar_t *)MODULE_NAME); 
  }
  ...
  if (wcscmp(pwstFuncName, L"blockgame") == 0) {
    addCStackFunction((wchar_t *)L"blockgame", &_wrap_blockgame, (wchar_t *)MODULE_NAME); 
  }
  return 1;
};
#else
static GenericTable Tab[] = {
  {
    (Myinterfun)sci_gateway, (GT)blockgame_Init, (char *)"blockgame_Init"
  },
  {
  ...
  {
    (Myinterfun)sci_gateway, (GT)_wrap_blockgame, (char *)"blockgame"
  }
};
